          ...
          child: Column(
            children: [
              Container(
                ...
                child:  Center(child: Text(' ${widget.storeName}')),
              ),
              SizedBox(height: 10,),
                                      ...
                                      Column(
                                        children: [
                                          Container(
                                            ...
                                            child: Center(child: Text('Order Date',style: TextStyle(fontSize: 17,color: Colors.black,fontWeight: FontWeight.bold),)),
                                          ),
                                          SizedBox(height: 10,),
                                          Container(
                                            height: 25,
                                            ...
                                            child: Center(child: Text('1/12/23',style: TextStyle(fontSize: 15,color: Colors.black),)),
                                          ),
                                          SizedBox(height: 10,),
                                          Container(
                                            height: 25,
                                            ...
                                            child: Center(child: Text('04/01/24',style: TextStyle(fontSize: 15,color: Colors.black),)),
                                          ),
                                          SizedBox(height: 10,),
                                          Container(
                                            height: 25,
                                            ...
                                            child: Center(child: Text('16/02/24',style: TextStyle(fontSize: 15,color: Colors.black),)),
                                          ),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          Container(
                                            ...
                                            child: Center(child: Text('Total Bill:',style: TextStyle(fontSize: 17,color: Colors.black,fontWeight: FontWeight.bold),)),
                                          ),
                                          SizedBox(height: 10,),
                                          Container(
                                            height: 25,
