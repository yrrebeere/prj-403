...
class _InventoryState extends State<Inventory> with RouteAware {
  ...
  void didPopNext() {
    ...
    _fetchAndDisplayCombinedData(vendorId); // Refresh data when returning to this page
  }
  ...
  void initState() {
    super.initState();
    final vendorId = Provider.of<UserProvider>(context, listen: false).vendorId;
    _fetchAndDisplayProductInventories(vendorId);
    _fetchAndDisplayCombinedData(vendorId);
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                ...
                if (result != null && result) {
                  _fetchAndDisplayCombinedData(vendorId); // Refresh the data if result indicates a change
                }
              },
